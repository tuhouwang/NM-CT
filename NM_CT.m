...
%     plot(imag(psi(1:40:size(psi,1),mode_num)),z(1:40:size(psi,1)),'k--','LineWidth',1);hold on;
%     plot(-real(psi(1:40:size(psi,1),mode_num)),z(1:40:size(psi,1)),'go','LineWidth',1);
